...
class CipherInitializerTest {
    ...
    @Nested
    class PrepareAndInitCipherShould {

        @Test
        void configure_cipher_with_AES_algorithm_and_CBC_mode() throws Exception {
            // When
        ...
        @Test
        void init_cipher_with_given_encryption_mode() throws Exception {
            // When
        ...
        @Test
        void init_cipher_with_given_key_as_bytes_array_and_AES_algorithm() throws Exception {
            // When
            spiedCipherInitializer.prepareAndInitCipher(encryptionMode, key);
        ...
        @Test
        void init_cipher_with_algorithm_parameter_spec_using_cipher_block_size() throws Exception {
            // When
            spiedCipherInitializer.prepareAndInitCipher(encryptionMode, key);
